...
public class DepartmentManagementBusinessService {
	...
	public void getDepartmentListRequestProcess() {
		...
		ResponseData responseData = departmentManagementDataCenterService.getResponseData();//暂存。。。
		commonService.setHeadForResponseDataWithResponseHeadOfSuccess(responseData);//设置头
		responseData.setData(data);//JSON放进去
	}
