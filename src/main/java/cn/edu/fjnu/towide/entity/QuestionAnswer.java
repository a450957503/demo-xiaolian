...
public class QuestionAnswer {
	...
	public QuestionAnswer(String id, String questionerUsername, String questionerRealName, String questionerNickName,
			String responderUsername, String responderRealName, String responderNickName, String questionContent,
			Date questionDateTime, String answerContent, Date answerDateTime, String mainQuestionId, String remark,
			Integer stars, Integer sequenceNumber, Integer addQuestionNumber, String state, String questionerReadState,
			String answererReadState) {
		this.id = id;
