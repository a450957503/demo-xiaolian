...
@Service
public class personmanagementBusinessService {
	@Autowired
	CommonService commonService;
	@Autowired
	personmanagementCheckService personmanagementCheckService;
	...
	public void getPersonnelListRequestProcess() {
		...
		ResponseData responseData=personmanagementDataCenterService.getResponseData();
